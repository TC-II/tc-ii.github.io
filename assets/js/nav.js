...
/* Borde inferior del header solo cuando la página está scrolleada.
   Se usa un centinela + IntersectionObserver en vez de un listener de scroll:
   no corre en cada frame de scroll. */
(function () {
